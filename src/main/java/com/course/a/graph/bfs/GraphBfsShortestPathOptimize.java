 ...
 * @Date 2022-08-22
 */
public class GraphBfsShortestPathOptimize {
    private Graph g;
    ...
    public GraphBfsShortestPathOptimize(Graph g, int source) {
        this.g = g;
        this.source = source;
    ...
    public static void main(String[] args) {
        ...
        GraphBfsShortestPathOptimize graphBfs = new GraphBfsShortestPathOptimize(g, 0);
        System.out.println(graphBfs.path(5));
        System.out.println(graphBfs.distance(5));
    }
}
